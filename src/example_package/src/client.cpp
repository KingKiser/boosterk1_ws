...
int main(int argc, char **argv) {
    ...
    auto req_move_msg = booster_interface::CreateMsg<
        ...
        booster::robot::b1::MoveParameter>(0.5, 0.0, 0.0); //다리 보폭을 위한 조인트로 추정됨
    ...
    tar_posture.orientation_ = booster::robot::Orientation(0., 0., 0.); //팔 조인트 위치 값으로 추정됨
